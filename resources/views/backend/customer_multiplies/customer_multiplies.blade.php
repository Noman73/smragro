 ...
 @section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Customer Wise Multiply System </div>
                </div>
                <div class="col-6">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="multiply" placeholder="Enter Multiply">
  ...
  @include('backend.customer_multiplies.internal-assets.js.script')
  @endsection