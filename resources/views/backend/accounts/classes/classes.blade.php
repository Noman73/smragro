 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Accounts Classes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Accounts Class</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Account Classes </div>
                </div>
                <div class="col-6">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add New Account Class</h5>
              ...
              <form>
                ...
                <div class="row">
                  <div class="col-md-8 mr-auto ml-auto">
                    ...
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Class Type:</label>
                      <select class="form-control" name="" id="class_type">
  ...
  @include('backend.accounts.classes.internal-assets.js.script')
  @endsection