 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Ledger Head</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Leadger Head</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Leadger Head</div>
                </div>
                <div class="col-6">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input type="checkbox" class="" id="sub_account" placeholder="Enter Name">
                      <label for="recipient-name" class="col-form-label "> Sub Account</label>
                      <div class="invalid-feedback" id="sub_account_msg">
                      </div>
                    </div>
                  </div>
                  {{-- <div class="col-md-8 mr-auto ml-auto">
  ...
  @include('backend.accounts.ledger.internal-assets.js.script')
  @endsection