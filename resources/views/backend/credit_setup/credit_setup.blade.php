 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Credit Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Credit Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Credit Setup</div>
                </div>
                <div class="col-6">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Credit Setup</h5>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-12">
                    <div class="form-group">
                      ...
                      <input name="amount" id="amount"  class="form-control amount" placeholder="0.00">
                    </div>
                  </div>
                  {{-- <div class="col-12 col-md-12">
  ...
  @include('backend.credit_setup.internal-assets.js.script')
  @endsection