 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Balance Analysis Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Customer Balance Analysis Report</div>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Customer Balance Analysis</div>
                    ...
                    <div class="col-7 mt-1 text-right d-none inv_ledger">
                          <label>Customer Name</label> : <span id="inv_ledger"></span><br>
  ...
  @include('backend.reports.customer_balance_analysis.internal-assets.js.script')
    <script>
      function  Print(){
        $('.report').printThis({
          importCSS: true,
