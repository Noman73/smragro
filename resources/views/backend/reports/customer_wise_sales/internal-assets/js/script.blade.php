...
$(document).on('click','.remove', function(e){
 ...
 console.log(removeArr);
  ...
  function Apply(){
    ...
    axios.post("{{URL::to('/admin/customer-wise-sale-report')}}",{from_date:fromDate,to_date:toDate,category:category,product:product,customer:customer})
    .then((res)=>{
      console.log(res)
      html="";
      res.data.forEach(function(d){
        console.log(d);
          ...
          html+="<td class='text-right'>"+d.qantity+"</td>";
