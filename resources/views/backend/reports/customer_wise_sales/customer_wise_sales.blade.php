 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Wise Sales Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Customer Wise Sales Report</div>
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12 col-md-3">
                  <div class="form-group">
                    ...
                    <select name="" id="customer" class='form-control'></select>
                  </div>
                </div>
                <div class="col-12 col-md-3">
                </div>
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Customer Wise Sale</div>
  ...
  @include('backend.reports.customer_wise_sales.internal-assets.js.script')
    <script>
      function  Print(){
