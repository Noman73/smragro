 ...
 @section('content')
            ...
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Profit Loss</div>
                ...
                <div style="line-height: 0;" class="text-right d-none inv_ledger">
                  <small><strong>Print Time :</strong> </small><small  id="print_time">4545421</small>
                    ...
                    <table style="border:1px solid black;" width='100%' class="table table-sm text-center table-borderless mt-4">
                        <thead>
                        <tr style="color:black;border-bottom:1px solid black;" class="">
                            <th style='border-right:1px solid black;' width='50%' ><span class="float-left">Particulars</span></th>
                            <th width='50%'><span class="float-left">Particulars</span></th>
                        </tr>
                        </thead>
                        <tbody style="line-height: 1.6;" id='data-load'>
                        </tbody>
                        <tfoot>
                          <th colspan="3"></th>
                          <th></th>
  ...
  @include('backend.reports.profit_loss.internal-assets.js.script')
    <script>
      function  Print(){
