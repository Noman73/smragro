 ...
 @section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Sale Pricing</div>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Sale Pricing</div>
  ...
  @include('backend.reports.sale_pricing.internal-assets.js.script')
    <script>
      function  Print(){
