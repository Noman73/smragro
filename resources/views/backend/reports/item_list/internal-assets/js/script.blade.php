...
//   }
  ...
  function Apply(){
    axios.post("{{URL::to('/admin/item-list-report')}}")
    .then((res)=>{
      console.log(res)
      html="";
      res.data.forEach(function(d){
        console.log(d);
          html+="<tr>"
          html+="<td class='text-left'>"+d.category.name+"</td>";
          html+="<td class='text-center'>"+d.name+"</td>";
          html+="<td class='text-right'>"+d.buy_price+"</td>";  
          html+="<td class='text-right'>"+d.sale_price+"</td></tr>";  
      })
      $('#data-load').html(html);
