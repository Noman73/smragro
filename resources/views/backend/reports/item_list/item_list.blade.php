 ...
 @section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Item Listing</div>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Item List</div>
                  ...
                  <small><strong>Print Time :</strong> </small><small  id="print_time"></small>
                    ...
                    <table class="table table-sm text-center  table-striped mt-4">
                        ...
                        <tr style="color:black;" class="">
                            ...
                            <th class="text-right" width="25%">Buy Price</th>
                            <th class="text-right" width="25%">Sale Price</th>
                        </tr>
                        </thead>
                        <tbody id='data-load'>
                        </tbody>
  ...
  @include('backend.reports.item_list.internal-assets.js.script')
    <script>
      function  Print(){
