 ...
 @section('content')
            ...
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Inventory</div>
  ...
  @include('backend.reports.product_wise_report.internal-assets.js.script')
    <script>
      function  Print(){
