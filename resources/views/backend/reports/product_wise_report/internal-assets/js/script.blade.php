...
$(document).on('click','.remove', function(e){
 ...
 console.log(removeArr);
  ...
  function Apply(){
    ...
    axios.post("{{URL::to('/admin/inventory-report')}}",{from_date:fromDate,to_date:toDate,category:category,product:product,customer:customer,supplier:supplier})
    .then((res)=>{
      console.log(res)
      html="";
      res.data.forEach(function(d){
        console.log(d);
          ...
          html+="<td class='text-right'>"+d.stock_in+"</td>";
          html+="<td class='text-right'>"+d.stock_out+"</td>";
          html+="<td class='text-right'>"+(parseFloat(d.stock_in-d.stock_out).toFixed(2))+"</td>";  
          html+="<td class='text-right'>"+((parseFloat(d.stock_in-d.stock_out))*(isNaN(parseFloat(d.price/d.stock_in)) ?0: parseFloat(d.price/d.stock_in))).toFixed(2)+"</td></tr>";  
      })
      $('#data-load').html(html);
