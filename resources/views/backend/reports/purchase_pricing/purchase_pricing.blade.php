 ...
 @section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Purchase Pricing</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header bg-dark">
              <div class="row">
                <div class="col-6">
                  <div class="card-title">Purchase Pricing</div>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Purchase Pricing</div>
                  ...
                  <small><strong>Print Time :</strong> </small><small  id="print_time">4545421</small>
                    ...
                    <table class="table table-sm text-center  table-striped mt-4">
                        ...
                        <tr style="color:black;" class="">
                            ...
                            <th width="30%">Last Purchase Price</th>
                            <th width="30%">Default Price</th>
  ...
  @include('backend.reports.purchase_pricing.internal-assets.js.script')
    <script>
      function  Print(){
