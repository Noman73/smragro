 ...
 @section('content')
            ...
            <div class="card-body">
              ...
              <div class="report " style="margin-left:80px;margin-right:80px;">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="h2 mb-4 float-right font-weight-bold">Trial Balance</div>
                  ...
                  <small><strong>Print Time :</strong> </small><small  id="print_time"></small>
                    ...
                    <table class="table_text table table-sm text-center  table-striped mt-4">
                        ...
                        <tr style="color:black;" class="">
                            <th class="text-left" width="20%">Class Name</th>
                            <th class="text-left" width="50%">Account Name</th>
                        ...
                        <tfoot>
                          <tr style="color:black;" class="">
                            ...
                            <th class="text-right" id="dr_count">0.00</th>
                            <th class="text-right" id="cr_count">0.00</th>
                          </tr>
                        </tfoot>
                    </table>
  ...
  @include('backend.reports.trial_balance.internal-assets.js.script')
    <script>
      function  Print(){
        $('.report').printThis({
          importCSS: true,
