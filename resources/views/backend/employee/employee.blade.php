 ...
 @section('content')
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="experience" placeholder="Enter Job Experience">
                      <div class="invalid-feedback" id="experience_msg">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      <label for="message-text" class="col-form-label">Job Department:</label>
                      <input type="text" class="form-control" id="department" placeholder="Enter Department">
                      <div class="invalid-feedback" id="department_msg">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" id="salary_msg">
                      </div>
                    </div>
                  </div>
  ...
  @include('backend.employee.internal-assets.js.script')
  @endsection