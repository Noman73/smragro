 ...
 @section('content')
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add New Employee Salary</h5>
                ...
                <div class="row">
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="" id="employee">
                        
                      </select>
                      <div class="invalid-feedback" id="employee_msg">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" id="month_msg">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback" id="amount_msg">
                      </div>
                    </div>
                  </div>
                </div>
  ...
  @include('backend.employee_salary.internal-assets.js.script')
  @endsection