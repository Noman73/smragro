            ...
            <div class="modal-body">
              <form>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mr-auto ml-auto d-none">
                    <div class="form-group">
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    {{-- <div class="form-group">
                      ...
                      <select name="unit_type" id="product_type" class="form-control" onchange="productType()">
                        <option value="">--select--</option>
                        <option value="1">Raw Materials</option>
                        <option value="2">Finish Good</option>
                        <option value="3">Purchase Product</option>
                        <option value="4">Combo Product</option>
                      </select>
                      <div class="invalid-feedback" id="product_type_msg">
                      </div>
                    </div> --}}
                  ...
                  <div class="col-md-8 mr-auto ml-auto d-none mt-4" id="product-table">
