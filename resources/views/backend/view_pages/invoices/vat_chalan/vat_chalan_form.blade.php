...
@php
// dd($invoice);
if($invoice->road_chalan!=null){
$r_chalan=URL::to('admin/view-pages/road_chalan/'.$invoice->road_chalan->invoice_id);
redirect($r_chalan);
}
@endphp
 ...
 @section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card ">
            ...
            <div class="card-body">
              @if($invoice->road_chalan==null)
                <form id="myForm" action="{{route('road_chalan.store')}}" method="POST">
                  @csrf
                  <div class="row">
          ...
          @php 
              ...
              <div class="float-right clearfix">
                ...
                <button class="btn btn-primary" onclick="formSubmission()">Road Chalan</button>
              </div>  
  ...
  <script>
    function formSubmission(){
      let road_chalan={!! json_encode($invoice->road_chalan,true) !!};
      // console.log((road_chalan.id));
      if(road_chalan==null){
        document.getElementById('myForm').submit();
      }else{
        // window.location=baseURL+"/admin/view-pages/road_chalan/"+road_chalan.invoice_id;
        window.open(baseURL+"/admin/view-pages/road_chalan/"+road_chalan.invoice_id, '_blank');
      }
    }
  </script>
  @endsection