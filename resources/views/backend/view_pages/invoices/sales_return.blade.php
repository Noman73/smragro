        ...
        <div class="card ">
            ...
            <div class="card-body">
              ...
              <div class="float-right clearfix">
                <a target='_blank' class="btn btn-warning" href='{{URL::to('admin/view-pages/sales-return-invoice-print/'.$invoice->id)}}'><i class="fa fa-print" aria-hidden="true"></i></a>
              </div>  
                                  ...
                                  <tbody>
                                    ...
                                    @foreach($invoice->sales as $sales)
                                          <tr>
                                              ...
                                              <td class="text-right">{{$sales->cred_qantity}} {{$sales->product->unit->name}}</td>
                                              <td class="text-right">৳{{$sales->price}}</td>
                                              <td class="text-right">৳{{($sales->cred_qantity*$sales->price)}}</td>
                                          </tr>
                                    @endforeach
                                  </tbody>
                              </table>
                  ...
                  <div class="footer">
        <span>This report has been taken from ERP, hence No signature required. </span><br>
