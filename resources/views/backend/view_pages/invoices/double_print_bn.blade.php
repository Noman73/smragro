...
<div class="container-fluid ">
    <table width="100%">
        <td style="padding-right:40px;border-right-style: dotted;">
            <div id="print" class="print" >
                <div class="row invoice_header">
                  <div class="col-xs-5" style="width: 60%; float:left;">
                    @include('layouts.adress')
                  </div>
                  <div class="col-xs-7" style="width: 40%; text-align:right">
                      <div style=" width:100%; text-align:right;">
                          ...
                          <span style='font-size:16px;font-weight:bold'>গ্রাহক কপি</span>
                      </div>
                  </div>
                </div>
            ...
            <div class="row invoice_header">
              ...
              <div class="col-xs-7" style="width: 40%; text-align:right">
                  <div style=" width:100%; text-align:right;">
                      ...
                      বিক্রয় ধরন :<b>{{$sale_type}}</b> <br>
                      তারিখ : {{date('d-m-Y',intval($invoice->dates))}}<br/>
                      <span style='font-size:16px;font-weight:bold'>অফিস কপি</span>
                  </div>
              </div>
            </div>
