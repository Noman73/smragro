    ...
    <div id="print" class="print" >
                  ...
                  <table width="100%" class="table table-bordered table-striped">
                      <thead>
                          <tr>
                              ...
                              <th width="35%" style="text-align:left">Product Name</th>
                      ...
                      <tbody>
                        ...
                        @foreach($invoice->sales as $sales)
                              <tr>
                                  ...
                                  <td style="text-align:right;">{{$sales->deb_qantity}} {{$sales->product->unit->name}}</td>
                                  <td style="text-align:right;">৳{{$sales->price}}</td>
                                  <td style="text-align:right;">৳{{($sales->deb_qantity*$sales->price)}}</td>
                              </tr>
                          </tbody>
                        @endforeach
                  </table>
      ...
      <div class="row">
          ...
          <div class="col-md-6" style="width:50%;float: right;" >
              <table width="100%"  class="table table-bordered payment_history">
