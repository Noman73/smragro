...
class ChartOfAccountController extends Controller
{
    ...
    public function index()
    {
        ...
        $query="SELECT classes.class_type,classes.name class_name,account_groups.name group_name,account_ledgers.name,ifnull(sum(voucers.debit),0) debit,ifnull(sum(voucers.credit),0.00) credit  from account_ledgers 
