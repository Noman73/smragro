...
use URL;
class ReceiveViewController extends Controller
{
    public function __construct() 
    {
        $this->middleware('auth');
        $this->middleware('permission:Receive Print',['only'=>'index']);
        $this->middleware('permission:Receive Print',['only'=>'print']);
    }
    public function index($id)
    {
        ...
        ",['id'=>$id]);
        // dd($invoice);
        return view('backend.view_pages.receive.receive',compact('invoice','vinvoice'));
    }
    public function print($id){
        ...
        $invoice=DB::select("
            ...
            order by voucers.id
        ",['id'=>$id]);
        return view('backend.view_pages.receive.print',compact('invoice','vinvoice'));
    }
}
