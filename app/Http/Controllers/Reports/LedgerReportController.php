    ...
    public function generateReport(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $arr= DB::select("
                    ...
                    (
                        SELECT voucers.id,voucers.invoice_id,voucers.v_inv_id,voucers.pinvoice_id,voucers.journal_inv_id,voucers.date,voucers.debit,voucers.credit,voucers.transaction_name,ifnull(voucers.comment,'') comment,voucers.created_at from voucers 
